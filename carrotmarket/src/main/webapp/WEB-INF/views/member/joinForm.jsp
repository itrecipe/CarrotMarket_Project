...
<div class="container" style="margin: 150px auto; width:80%;">
	<form action="join" style="padding-top: 30px; width: 50%; margin: 0 auto;" id="join_form" method="post">
		<h1>이름</h1>
		<input type="text" name="username" style="width: 100%; padding:10px 0; required"/>
		
		<h1>닉네임</h1>
		<input type="text" name="nickname" style="width: 100%; padding:10px 0; required"/>
		
		<h1>아이디</h1>
		<input type="text" name="userid" style="width: 100%; padding:10px 0; required"/>
		...
		<h1>비밀번호</h1>
		<input type="password" name="userpwd" style="width: 100%; padding:10px 0; required"/>
		...
		<input type="submit" name="join_submit" value="회원가입" style="width: 100%; background-color: #ff6f0f; color:white"/>
		<input type="button" name="join_reset" value="취소" onclick="history.back()" style="width: 100%; background-color: #ff6f0f; color:white"/>
	</form>
</div>
