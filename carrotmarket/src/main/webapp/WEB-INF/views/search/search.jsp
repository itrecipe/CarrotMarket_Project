		...
		<div id="flea-market-wrap" class="articles-wrap">
			<div style="display: flex; justify-content: space-between;">
				...
				<c:if test="${loginUser != null }">
					<a href="/carrotmarket/articles/new" class="article-kind">당근 등록</a>
				</c:if>
			</div>
			<article class="flea-market-article flat-card">
				<a class="flea-market-article-link" href="../articles/get">
					...
					<div class="article-info">
						<div class="article-title-content">
							<span class="article-title">(미개봉) 삼성 갤럭시북2 NT550XEZ-A58A
								(사무용 노트북. 업무용 노트북) 삼성노트북</span> 
								<span class="article-content">미개봉
