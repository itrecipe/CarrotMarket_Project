...
import org.ezen.carrotmarket.util.JScript;
...
public class MemberController {
	...
	public String joinAction(MemberVO memberVO) {
		...
		return JScript.href("회원가입완료", "/carrotmarket/member/login");
	}
	...
	// 내정보 수정 후 저장
		...
		public String modify(MemberVO memberVO){
			...
			return JScript.href("회원정보 수정 완료", "/carrotmarket/member/myInfo");
		}
		//비밀번호 변경 폼
		@GetMapping("/passwd")
		...
		public String passwd(String passwd, String newPasswd, String newPasswdConfirm, HttpSession session){
			...
			return JScript.href("비밀번호 변경 완료", "/carrotmarket/member/logoutAction");			
		}
		...
		public String remove(String passwd, HttpSession session){
			...
			return JScript.href("회원탈퇴 완료", "/carrotmarket/member/logoutAction");
		}
